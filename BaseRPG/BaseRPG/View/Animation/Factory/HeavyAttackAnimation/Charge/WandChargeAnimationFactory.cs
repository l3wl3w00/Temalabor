...
{
    public class WandChargeAnimationFactory : IAttackAnimationFactory
    {
        private IViewManager viewManager;
        private InputHandler inputHandler;
        private Weapon weapon;
        public WandChargeAnimationFactory(IViewManager viewManager, InputHandler inputHandler, Weapon weapon)
        {
        ...
        public TransformationAnimation2D CreateTransformation(IAttackFactory attackFactory)
        {
            ...
            var facingPointAnimation = FacingPointAnimation.WithChangingOffset(App.IMAGE_SCALE * 25,App.IMAGE_SCALE * 15,1);
